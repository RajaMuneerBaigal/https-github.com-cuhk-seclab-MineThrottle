...
BUILD_DIR=Release # Change this if you want to build at a different directory, e.g., MineThrottle
PATCH_DIR=patches # Change this if you put the .patch files at a different directory


# HELP
print_help ()
{
  echo "Usage : ./build_minethrottle.sh options"
  echo "  e.g., ./build_minethrottle.sh --all"
  echo ""
  echo "options:"
